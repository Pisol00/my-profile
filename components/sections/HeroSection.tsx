...
const HeroSection = forwardRef<HTMLElement, HeroSectionProps>(
  ({ animationsEnabled, onScrollToNext }, ref) => {
    ...
    return (
      <section ref={ref} className="min-h-screen pt-24 pb-20 relative overflow-hidden bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-blue-950/30">
        {/* Decorative Elements */}
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
            ...
            >
              <div className="relative">
                ...
                <div className="relative w-72 h-72 md:w-80 md:h-80 overflow-hidden rounded-full border-4 border-white dark:border-gray-800 shadow-xl">
                  <Image
                    src="/profile-image.jpg" // ควรสร้างไฟล์นี้ในโฟลเดอร์ public
                    alt={profile.name}
                    fill
          ...
          <div className="flex justify-center mt-16">
            <button
              ...
              className="cursor-pointer group bg-white dark:bg-gray-800 p-3 rounded-full border border-blue-200 dark:border-blue-800 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all shadow-md"
            >
...
// เพิ่ม displayName เพื่อให้ forwardRef component มี name ที่ชัดเจนใน devtools
